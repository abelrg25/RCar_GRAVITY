...
<img src="https://user-images.githubusercontent.com/61716000/211625765-533ea754-47e3-4504-9cbb-64789048129f.png" width="350")

#### Fig 6. Corner plot of all the one and two dimensional projections of the posterior probability distributions of our parameters. As shown in Fig. 3, the marginalized distribution for each parameter independently is shown in the histograms along the diagonal and then the marginalized two dimensional distributions in the other panels.   
